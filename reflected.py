...
wn = turtle.Screen()
wn.bgcolor('black')
wn.setworldcoordinates(-100, -100, 100, 100)  # set the coordinates of the turtle window
...
x_axis.pendown()
x_axis.goto(98, 0)
x_axis.write("X", font=("Arial", 15, "bold"))  # label the x-axis
...
y_axis.pendown()
y_axis.goto(0, 98)
y_axis.write("Y", font=("Arial", 15, "bold"))  # label the y-axis
...
t1.goto(polygon[0][0], polygon[0][1])
t1.write("Original", font=("Arial", 15, "normal"))  # label the original polygon
...
t2.goto(reflected_polygon[0][0], reflected_polygon[0][1])
t2.write("Reflected", font=("Arial", 15, "normal"))  # label the reflected polygon
